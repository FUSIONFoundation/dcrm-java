...
public static String base58_PrivateKey_to_HexPrivateKey(String str)
{
...
public static String base58compressed_PrivateKey_to_HexPrivateKey(String str)
{
...
public static String base64_PrivateKey_to_HexPrivateKey(String str)
{                     
	byte[] erg = Base64.getDecoder().decode(str);
	return Base58Util.byteArrayToHexString(erg);
}
